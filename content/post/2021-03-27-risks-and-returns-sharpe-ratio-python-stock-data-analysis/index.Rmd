...
stock_data.plot(kind= "line",subplots= True, title= "Stock Data", linewidth= 1.0, color= ("darkorange", "blue"))
plt.tight_layout()
plt.show()
...
benchmark_data.plot(kind= "line",title= 'S&P 500', linewidth= 1.0)
plt.show()
...
stock_returns.plot(subplots= True, linewidth= 1.0, color= ("darkorange", "darkblue"))
plt.show()
...
excess_returns.plot(linewidth= 1.0, subplots= True, color= ("darkorange", "darkblue"))
plt.tight_layout()
plt.show()
...
avg_excess_return.plot(linewidth= 1.0)
plt.show()
```
...
sd_excess_return.plot.bar(linewidth= 1.0,title='Standard Deviation of the Return Difference', color=("darkorange","darkblue"), width= 0.5)
...
annual_sharpe_ratio.plot(linewidth= 1.0, title= 'Annualized Sharpe Ratio: Stocks vs S&P 500')
